...
echo "[PyTorch-Quantization] PyTorch-Quantization data sets will be stored in tree under ${PATH_HARD_SYSTEMS_PKG_4DATA}."
...
PATH_HARD_SYSTEMS_PKG_4LOGS=$(python -c "${PYTHON_READ_STORAGE_CFG_LOGS}")/$(basename ${PATH_QUANTLAB_HOME})/experiments
mkdir -p ${PATH_HARD_SYSTEMS_PKG_4LOGS}
echo "[PyTorch-Quantization] PyTorch-Quantization logs will be stored in tree under ${PATH_HARD_SYSTEMS_PKG_4LOGS}."